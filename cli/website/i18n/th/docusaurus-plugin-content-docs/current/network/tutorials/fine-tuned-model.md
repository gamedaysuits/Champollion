...
คู่มือนี้อธิบายแนวทาง ข้อกำหนดด้านข้อมูล และข้อควรระวัง โครงสร้างพื้นฐานสำหรับการ training จริงอยู่นอกขอบเขตของ harness
:::
...
:::danger[การปนเปื้อนของข้อมูล Eval = การตัดสิทธิ์]
ข้อมูล training ของคุณต้องไม่ทับซ้อนกับชุดข้อมูลสำหรับการประเมิน ไม่ว่าจะเป็นประโยค รายการคำศัพท์ หรือการถอดความเนื้อหาเดียวกัน harness จะตรวจสอบ fingerprint ของ output คุณ และสามารถตรวจจับความทับซ้อนทางสถิติได้ หากคุณไม่แน่ใจว่าแหล่งข้อมูลนั้นเป็นอิสระหรือไม่ ให้เลือกตัดออกไว้ก่อน ดูเพิ่มเติมที่ [กฎของ Leaderboard](/docs/network/leaderboard/rules)
:::
...
- [ชุดข้อมูลประเมินผล](/docs/network/leaderboard/datasets) — ทราบว่าคุณ **ไม่สามารถ** ฝึกบนข้อมูลใดได้บ้าง
- [กฎของ Leaderboard](/docs/network/leaderboard/rules) — นโยบายการปนเปื้อน
