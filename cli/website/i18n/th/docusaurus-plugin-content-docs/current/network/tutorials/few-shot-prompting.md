...
คู่มือนี้อธิบายแนวทางและการตัดสินใจออกแบบที่สำคัญ ปรับใช้ให้เหมาะกับคู่ภาษาและทรัพยากรที่คุณมี
:::
...
:::danger[ห้ามใช้ข้อมูล evaluation เป็นตัวอย่าง few-shot]
หากตัวอย่างของคุณมาจากชุดข้อมูล evaluation วิธีการของคุณจะถูก**ตัดสิทธิ์**จาก leaderboard ตัวอย่าง few-shot ต้องมาจากแหล่งที่เป็นอิสระ เช่น พจนานุกรม ตำราเรียน คู่ภาษาที่ผ่านการตรวจสอบโดยชุมชน หรือชุดข้อมูล development แยกต่างหาก harness จะบันทึก fingerprint ของ prompt ที่คุณใช้ และสามารถตรวจพบการปนเปื้อนของข้อมูลได้
:::
...
- [กฎการประเมิน MT](/docs/network/leaderboard/rules) — สิ่งที่จะถูกตัดสิทธิ์
- [ชุดข้อมูลประเมินผล](/docs/network/leaderboard/datasets) — ทราบว่าสิ่งใดที่คุณ**ไม่สามารถ**ใช้เป็นตัวอย่าง
