...
> **วัตถุประสงค์** เอกสารนี้กำหนดสิ่งที่เราต้องการอย่างชัดเจนจากผู้พูดสองภาษา Cree–English เพื่อตรวจสอบความถูกต้องของเมตริกการประเมิน LYSS หากไม่มีการตรวจสอบนี้ คะแนนอัตโนมัติของเราจะเป็นเพียงการประมาณการทางวิศวกรรม ไม่ใช่การวัดคุณภาพที่ได้รับการพิสูจน์แล้ว นี่คือช่องว่างที่สำคัญที่สุดเพียงจุดเดียวในโปรเจกต์
>
> **กลุ่มเป้าหมาย** พันธมิตรในชุมชน ผู้ที่อาจมาร่วมงาน ผู้พิจารณาทุน และทีมงานโปรเจกต์
...
1. เราเรียกใช้ FST analyzer กับ EdTeKLA dev corpus จำนวน 436 รายการของเรา (`textbook_dev.json`) และรวบรวมทุกคำที่ระบบปฏิเสธ
2. เรานำเสนอคำที่ถูกปฏิเสธสูงสุด 100 คำแก่ผู้พูดพร้อมบริบทในประโยค
3. สำหรับแต่ละคำ ผู้พูดจะตอบคำถามดังนี้:
   - **นี่คือคำภาษา Cree ที่ถูกต้องหรือไม่?** ใช่ / ไม่ใช่ / ไม่แน่ใจ
   - **ถ้าใช่ เป็นคำประเภทใด?** คำที่มีการใช้ทั่วไป / คำยืม / ชื่อเฉพาะ / รูปแบบภาษาถิ่น / คำสร้างใหม่ / อื่นๆ
   - **หมายเหตุ** (ไม่บังคับ)
...
การมีส่วนร่วมทั้งหมดของผู้พูดจะอยู่ภายใต้นโยบายข้อมูลที่มุ่งสู่อธิปไตยทางข้อมูลของโปรเจกต์:
...
การตรวจสอบความถูกต้องโดยผู้พูดเป็นขั้นตอนหนึ่งของไปป์ไลน์ที่ใหญ่กว่า: เวิร์กโฟลว์
[ความร่วมมือด้านคลังข้อมูล](/docs/network/specifications/corpus-partnership)
คือส่วนที่งานเหล่านี้ประกอบเข้าด้วยกันเพื่อสร้างคลังข้อมูลสำหรับการประเมิน และ
[วิธีการจ่ายค่าตอบแทนผู้พูด](/docs/network/perspectives/how-speakers-get-paid)
คือเวอร์ชันภาษาที่เข้าใจง่ายของอัตราค่าตอบแทนและเงื่อนไขข้างต้น
