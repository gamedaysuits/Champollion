/**
 * mini-schema.mjs — a dependency-free JSON Schema (draft 2020-12 subset) validator.
 *
 * The repo deliberately ships NO ajv in either runtime (see
 * mt-eval-arena/scripts/lib/mini-schema.mjs, the SSOT this is vendored from —
 * kept byte-identical so the two never drift). It covers exactly the constructs
 * our SSOT schemas use: type (incl. arrays-of-types and null), required, enum,
 * pattern, properties, additionalProperties:false, items, $ref ("#/$defs/..."),
 * minimum/maximum, minLength, minItems. It is NOT a general-purpose validator —
 * it is deliberately small and auditable.
 *
